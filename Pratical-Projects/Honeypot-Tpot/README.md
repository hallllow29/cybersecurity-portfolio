...
**Network Configuration:** All common service ports were exposed to maximize the attack surface. Administrative SSH access was moved to a non-standard high port (64295), and the web management UI runs on port 64297. Both are protected via firewall rules allowing only trusted IPs.
...
![Honeypot Attack Distribution](../../.gitbook/assets/01-attack-distribution.png)
...
![Honeypot Attack Types Bar Chart](../../.gitbook/assets/02-attack-trypes-bar.png)
...
![Honeypot Attack Histogram](../../.gitbook/assets/03-attack-histogram.png)
...
![Attacks by Destination Port Histogram](../../.gitbook/assets/04-port-histogram.png)
...
![Attacks by Country Histogram](../../.gitbook/assets/05-country-histogram.png)
...
![Attacks by Country Pie Chart](../../.gitbook/assets/06-country-pie.png)
...
![Attacker IP Reputation](../../.gitbook/assets/07-ip-reputation.png)
...
![P0f OS Distribution](../../.gitbook/assets/08-os-distribution.png)
...
![Attacks by Honeypot Pie](../../.gitbook/assets/09-honeypot-pie.png)
...
![Suricata Alert Histogram](../../.gitbook/assets/10-suricata-histogram.png)
...
![Username Tagcloud](../../.gitbook/assets/11-username-tagcloud.png)
...
![Password Tagcloud](../../.gitbook/assets/12-password-tagcloud.png)
...
![Top ASNs and Source IPs](../../.gitbook/assets/13-asn-and-ips.png)
...
![Suricata Alert Signatures](../../.gitbook/assets/14-suricata-signatures.png)
