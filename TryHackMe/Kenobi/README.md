...
![Resultado do Nmap](../../.gitbook/assets/01-nmap-scan.png)
...
![Smbclient shares](../../.gitbook/assets/02-smblcient-shares.png)

```bash
smbclient //10.10.19.34/anonymous
```

Inside the share, I found a file named `log.txt`. I downloaded it for further analysis using the `get` command within the `smbclient` prompt. ![Inside Share](../../.gitbook/assets/03-inside-share.png) ![Get File](../../.gitbook/assets/04-get-file.png) ![Inside file](../../.gitbook/assets/05-inside-file.png)
...
The `log.txt` file confirmed that ProFTPD was running on **port 21**. My initial `nmap` scan had already identified the version as **1.3.5**. A quick search with `searchsploit` revealed that this specific version is vulnerable. ![FTP Version](../../.gitbook/assets/06-ftp-version.png)

```bash
searchsploit proftpd 1.3.5
```

![Searchsploit](../../.gitbook/assets/07-searchsploit.png) The search returned **3 main exploits**. The most relevant one is related to the `mod_copy` module, which allows an unauthenticated user to copy files on the server using the `SITE CPFR` (Copy From) and `SITE CPTO` (Copy To) commands.
...
![CPRF/CPTO](../../.gitbook/assets/08-CPFR-CPTO.png)
...
![Mkdir](../../.gitbook/assets/09-mkdir.png) ![Mount](../../.gitbook/assets/10-mount.png) ![View mount](../../.gitbook/assets/11-view-mount.png) ![Cp id\_rsa](../../.gitbook/assets/12-cp-id_rsa.png)
...
![Login SSH](../../.gitbook/assets/13-login-ssh.png)
...
![Perms](../../.gitbook/assets/14-perms.png)
...
![Create curl](../../.gitbook/assets/15-create-curl.png)

![Enter menu](../../.gitbook/assets/16-enter-menu.png)

![Root permission](../../.gitbook/assets/17-root-permision.png)
...
![Root Flag](../../.gitbook/assets/18-root-flag.png)
