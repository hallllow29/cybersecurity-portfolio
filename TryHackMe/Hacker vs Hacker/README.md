...
![Resultado do Nmap](../../.gitbook/assets/01-Reconhecimento.png)

**Results:**

* **22/tcp – OpenSSH 8.2p1 (Ubuntu 20.04)**
* **80/tcp – Apache 2.4.41 (Ubuntu)**
* No additional high-value services exposed. The host runs a typical Apache/PHP stack on Ubuntu 20.04, indicating that web exploitation is the likely entry point.
...
![Web Page](../../.gitbook/assets/02-WebPage.png)
...
![Upload](../../.gitbook/assets/03-Upload.png)

Inspecting the source code of `upload.php` revealed the following logic:

![Source Code](../../.gitbook/assets/04-SourceCode.png)
...
![Web Shell](../../.gitbook/assets/05-WebShell.png)
...
![Netcat](../../.gitbook/assets/06-Netcat.png)
...
![Reverse Shell](../../.gitbook/assets/07-Revshell.png)
...
![User Flag](../../.gitbook/assets/08-UserFlag.png)
...
![CronTab](../../.gitbook/assets/09-Crontab.png)
...
![backup.sh](../../.gitbook/assets/10-backup.png)
...
![permissions](../../.gitbook/assets/11-permissions.png)
...
![Bash History](../../.gitbook/assets/12-BashHistory.png)

With this information, an SSH connection as `lachlan` was established successfully:

![SSH Connection](../../.gitbook/assets/13-ssh.png)
...
![Exploit Crontab](../../.gitbook/assets/14-exploit.png)
...
![Root Privs](../../.gitbook/assets/15-root.png)

Accessing `/root` revealed the final flag:

![Root Flag](../../.gitbook/assets/16-RootFlag.png)
