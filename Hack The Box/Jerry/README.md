...
The first step in our penetration testing methodology involved conducting a comprehensive network scan using Nmap to identify open ports, services, and their respective versions running on the target machine. This initial information is crucial for understanding the attack surface and pinpointing potential vulnerabilities. The following Nmap command was executed:

```bash
nmap -sV -sC 10.10.10.95
```

![Resultado do Nmap](<../../.gitbook/assets/01-nmap-scan (1).png>)
...
![Web Tomcat](../../.gitbook/assets/02-web-tomcat.png)
...
![Gobuster](<../../.gitbook/assets/03-gobuster (1).png>)
...
![Gobuster result](../../.gitbook/assets/04-gobuster-result.png)
...
![Access URL](../../.gitbook/assets/05-access-url.png)
...
![Credentials](../../.gitbook/assets/06-credentials.png)
...
![WAR File](../../.gitbook/assets/07-warfile.png)
...
![msfvenom rev shell](../../.gitbook/assets/08-msfvenom.png)
...
* `> shell.war`: Redirects the output to a file named `shell.war`. Before deploying the `shell.war` file, a Netcat listener was set up on our attacking machine to catch the incoming reverse shell connection.

```bash
nc -lvnp 9001
```

![Netcat](../../.gitbook/assets/09-netcat.png)
...
![Upload Shell](../../.gitbook/assets/10-upload-shell.png)
...
![Shell](../../.gitbook/assets/11-shell.png)
...
![Navitage to desktop](../../.gitbook/assets/12-navigate-to-desktop.png)
...
![Navitage to desktop](../../.gitbook/assets/13-flags.png)
